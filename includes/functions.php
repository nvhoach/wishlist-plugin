...
if ( ! function_exists( 'get_number_products_in_wishlist' ) ) {
	function get_number_products_in_wishlist( $wishlist_id ) {
		$result = get_post_meta( $wishlist_id, 'vi_woo_wishlist_meta', true );
